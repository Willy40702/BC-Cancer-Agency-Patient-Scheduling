...
public class Branch implements ActionListener
{
 ...
 //public String name = "BRANCH_NAME";
...
/*
 ...
 private void insertBranch()
 {
	...
	try
	{
	  ...
	  System.out.print("\nBranch Manager: ");
	  bmanager = in.readLine();
	  ps.setString(6, bmanager);
 ...
 private void deleteBranch()
 {
	...
	try
	{
	  ...
	  */
	  ...
	  ps = con.prepareStatement("DELETE FROM branch WHERE branch_phone = ?");
	  ...
	  if (rowCount == 0)
	  {
	      System.out.println("\nBranch with phone number " + bid + " does not exist!");
	  }
 ...
 private void showBranch()
 {
	...
	try
	{
	  ...
	  while(rs.next())
	  {
	      ...
	      bmanager = rs.getString("branch_manager");
	      if (rs.wasNull())
	      {
	    	  System.out.printf("%-15.15s\n", " ");
           }
